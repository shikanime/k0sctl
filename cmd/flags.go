...
func initConfig(ctx *cli.Context) error {
	...
	for _, f := range configs {
		...
		// Use a named reader to carry origin information instead of a second arg
		if err := manifestReader.Parse(manifest.NewNamedReader(bytes.NewReader(subst), f)); err != nil {
